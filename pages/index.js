  ...
  return (
    <>
      <header className="w-full md:py-8 md:px-14 font-Rubik text-gray-800  py-8 animate-fade-in-down border-b border-black">
        ...
        <p>Join us on a journey into the unknown, where we contemplate the consequences of a world forever changed by environmental challenges. Earther is your portal to thought-provoking insights, research, and discussions surrounding a post-Earth scenario.</h1>
