                        ...
                        {showDropDown && (
                            <div className=" font-semibold text-gray-600 absolute bg-white  z-50 list-none divide-y divide-gray-100 rounded-md w-[200px]  shadow-xl my-4 animate-fade-in-down" >
                                <ul className="py-1" >
                                    ...
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('curse)}>Curse</span>
                                    </li>
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('village')}>Village</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('ghost')}>Ghost</span>
                                    </li>
                                </ul>
                            </div>
                        )}
